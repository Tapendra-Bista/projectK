  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality().equals(other.favId, favId));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, const DeepCollectionEquality().hash(favId));

  @override
  String toString() {
    return 'FavoriteModel(id: $id, favId: $favId)';
  }
}
...
abstract mixin class $FavoriteModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, List<String> favId});
}
...
extension FavoriteModelPatterns on FavoriteModel {
  ...
  TResult maybeWhen<TResult extends Object?>(
    TResult Function(String id, List<String> favId)? $default, {
    required TResult orElse(),
  }) {
    final _that = this;
    switch (_that) {
      case _FavoriteModel() when $default != null:
        return $default(_that.id, _that.favId);
      case _:
        return orElse();
    }
  }
...
class _FavoriteModel implements FavoriteModel {
  const _FavoriteModel({required this.id, required final List<String> favId})
      : _favId = favId;
  ...
  @override
  List<String> get favId {
    if (_favId is EqualUnmodifiableListView) return _favId;
    // ignore: implicit_dynamic_type
    return EqualUnmodifiableListView(_favId);
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.id, id) || other.id == id) &&
            const DeepCollectionEquality().equals(other._favId, _favId));
  }

  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, const DeepCollectionEquality().hash(_favId));
